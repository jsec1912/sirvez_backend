                            ...
                            <tr>
                                <td style="font-family:helvetica,arial;background-color:White;padding:10px;font-size:14px;color:#555;line-height:21px;padding:20px">
                                    <table cellpadding="5px" border="0" style="font-size:1em;color:#555;font-size:14px;line-height:120%;margin-top:10px">									   
                                        ...
                                        <tr>
                                            <td colspan="2">Dear {{ucwords($pending_user['first_name'])}}</td>
                                        </tr>
        
                                        <tr>
                                            <td colspan="2" align="center"><h3>'{{$user_info->first_name}} {{$user_info->last_name}}' invited you to sirvez. Please Accept the invitation below and complete your registration.</h3></td>
                                        </tr>
                                
                                        <tr>
                                            <td colspan="2">sirvez.com is a project management tool built for fast paced interactive, agile communication with clients.</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="2" align="center"><a href="{{$invitationURL}}" style="background-color: #3f51b5; 
                                                ...
                                                font-size: 16px;border-radius: 4px;">Accept Invitation</a>
                                            </td>
                                        </tr>
